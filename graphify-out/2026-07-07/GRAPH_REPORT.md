# Graph Report - plumbfix  (2026-07-07)

## Corpus Check
- 189 files · ~785,779 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 534 nodes · 576 edges · 169 communities (164 shown, 5 thin omitted)
...
9. `PlumbfixImprovementsTest` - 11 edges
10. `Staff` - 9 edges
...
- **Why does `PaymentReceipt` connect `Plumber Controller Group` to `Community 160`, `Booking Model Group`?**
  _High betweenness centrality (0.102) - this node is a cross-community bridge._
- **Why does `Controller` connect `Invoice Controller Group` to `Community 160`, `Staff Controller Group`, `Plumber Controller Group`, `Community 138`, `Community 144`, `Community 154`?**
