# Graph Report - plumbfix  (2026-07-03)

## Corpus Check
- 183 files · ~742,810 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 518 nodes · 553 edges · 155 communities (151 shown, 4 thin omitted)
...
## Communities (155 total, 4 thin omitted)
...
- **Why does `Controller` connect `Invoice Controller Group` to `Staff Controller Group`, `Chat Controller Group`, `Plumber Controller Group`, `Community 138`, `Community 12`?**
