# Graph Report - plumbfix  (2026-07-18)

## Corpus Check
- 193 files · ~808,306 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 582 nodes · 629 edges · 173 communities (168 shown, 5 thin omitted)
...
## Knowledge Gaps
- **94 isolated node(s):** `Request`, `$schema`, `name`, `type`, `description` (+89 more)
...
- **Why does `Controller` connect `Invoice Controller Group` to `Community 160`, `Staff Controller Group`, `Community 163`, `Plumber Controller Group`, `Community 138`, `Community 144`?**
