...
<head>
    <meta charset="UTF-8">
    <title>Invoice #INV-{{ sprintf('%05d', $jobRecord->jobRecordID) }} — Plumbfix</title>
    <style>
        body {
...
<body>
        ...
        <table class="header-table">
            <tr>
                ...
                <td class="meta-section">
                    ...
                    <div><strong>Invoice ID:</strong> #INV-{{ sprintf('%05d', $jobRecord->jobRecordID) }}</div>
                    <div style="font-size: 11px; color:#64748b; margin-top:3px;">Date Generated: {{ date('d M Y, h:i A') }}</div>
                </td>
            </tr>
        </table>
    </div>
            ...
            <td class="info-col">
                <div class="info-block">
                    ...
                    <div class="info-row" style="margin-top: 5px;">
                        ...
                        <span>{{ $jobRecord->booking->customer->customerAddress ?? '—' }}</span>
                    </div>
                </div>
            </td>
            <td class="info-col">
                <div class="info-block-right">
                    ...
                    <div class="info-row">
                        <strong>Job Date:</strong> <span>{{ $jobRecord->jobRecordCompletionDate ? $jobRecord->jobRecordCompletionDate->format('d M Y') : '—' }}</span>
                    </div>
                    <div class="info-row">
                        <strong>Booking reference:</strong> <span>#BKG-{{ sprintf('%04d', $jobRecord->bookingID) }}</span>
                    </div>
                </div>
            </td>
        </tr>
    ...
    <div class="details-title">Technician Notes & Completion Remarks</div>
    ...
    <div class="cost-section">
        <table class="cost-table">
            ...
            <tr>
                ...
                <td class="value">- RM {{ number_format($jobRecord->booking->bookingDepositAmount ?? 50.00, 2) }}</td>
            </tr>
            <tr class="total">
                <td class="label">Balance Due</td>
                <td class="value">RM {{ number_format(max(0, $jobRecord->jobRecordTotalCost - ($jobRecord->booking->bookingDepositAmount ?? 50.00)), 2) }}</td>
            </tr>
        </table>
        <div class="clear"></div>
    </div>
    ...
    <div class="report-footer">
        <p>This invoice serves as an official receipt of completed plumbing services. For any questions, please contact billing@plumbfix.com.</p>
        <p style="margin-top: 4px; font-weight: bold; color:#2563eb;">Thank you for your business!</p>
    </div>
